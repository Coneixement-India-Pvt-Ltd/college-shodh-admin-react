  ...
  return (
    <form onSubmit={handleSubmit}>
      <div className="grid grid-cols-1 gap-4 ml-80 mr-20">
            ...
            <div className="flex flex-wrap gap-2">
              <label>
                <input
                  ...
                  checked={formData.courses === "Computer Science Engineering"}
                  onChange={handleChange}
                />
              ...
              <label>
                <input
                  ...
                  checked={formData.courses === "Mechanical Engineering"}
                  onChange={handleChange}
                />
              ...
              <label>
                <input
                  ...
                  checked={formData.courses === "Electrical Engineering"}
                  onChange={handleChange}
                />
              ...
              <label>
                <input
                  ...
                  checked={formData.courses === "Civil Engineering"}
                  onChange={handleChange}
                />
                Civil Engineering
              </label>
              <label>
                <input
                  ...
                  checked={formData.courses === "Aeronautical Engineering"}
                  onChange={handleChange}
                />
              ...
              <label>
                <input
                  ...
                  checked={formData.courses === "Chemical Engineering"}
                  onChange={handleChange}
                />
              ...
              <label>
                <input
                  ...
                  checked={formData.courses === "Automobile Engineering"}
                  onChange={handleChange}
                />
              ...
              <label>
                <input
                  ...
                  checked={formData.courses === "Biomedical Engineering"}
                  onChange={handleChange}
                />
              ...
              <label>
                <input
                  ...
                  checked={formData.courses === "Aerospace Engineering"}
                  onChange={handleChange}
                />
              ...
              <label>
                <input
                  ...
                  checked={formData.courses === "Marine Engineering"}
                  onChange={handleChange}
                />
                Marine Engineering
              </label>
              <label>
                <input
                  ...
                  checked={formData.courses === "Petroleum Engineering"}
                  onChange={handleChange}
                />
              ...
              <label>
                <input
                  ...
                  checked={formData.courses === "Food Engineering"}
                  onChange={handleChange}
                />
                Food Engineering
              </label>
              <label>
                <input
                  ...
                  checked={formData.courses === "Agricultural Engineering"}
                  onChange={handleChange}
                />
              ...
              <label>
                <input
                  ...
                  checked={
                    formData.courses === "Information Technology Engineering"
                  }
                  onChange={handleChange}
                />
              ...
              <label>
                <input
                  ...
                  checked={formData.courses === "Biotechnology Engineering"}
                  onChange={handleChange}
                />
            ...
            <div className="flex flex-wrap gap-2">
              ...
              <label>
                <input
                  ...
                  checked={formData.courses === "Computer Sceince"}
                  onChange={handleChange}
                />
                Computer Sceince
              </label>
              ...
              <label>
                <input
                  ...
                  checked={formData.courses === "Information Technology"}
                  onChange={handleChange}
                />
              ...
              <label>
                <input
                  ...
                  checked={formData.courses === "Computer Programming"}
                  onChange={handleChange}
                />
              ...
              <label>
                <input
                  ...
                  checked={formData.courses === "Nautical Science"}
                  onChange={handleChange}
                />
                Nautical Science
              </label>
              ...
              <label>
                <input
                  ...
                  checked={formData.courses === "Fashion Technology"}
                  onChange={handleChange}
                />
                Fashion Technology
              </label>
              <label>
                <input
                  ...
                  checked={formData.courses === "Forensic Science"}
                  onChange={handleChange}
                />
                Forensic Science
              </label>
              <label>
                <input
                  ...
                  checked={formData.courses === "Medical Technology"}
                  onChange={handleChange}
                />
                Medical Technology
              </label>
              ...
              <label>
                <input
                  ...
                  checked={formData.courses === "Environment & Sustainability"}
                  onChange={handleChange}
                />
              ...
              <label>
                <input
                  ...
                  checked={formData.courses === "Exercise & Sports Science"}
                  onChange={handleChange}
                />
        ...
        <div>
          <label className="block mb-2">Principal/HOD/Director Name:</label>
          <input
            type="text"
            name="principal"
        ...
        <div>
          <label className="block mb-2">Year of Start of Program :</label>
          <input
            type="date"
            name="date_of_estb"
            value={formData.date_of_estb}
            onChange={handleChange}
            className="border w-full"
          />
        </div>
